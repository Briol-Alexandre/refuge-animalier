                ...
                <div class="overflow-y-scroll h-[80%]">
                    <ul class="flex flex-col gap-4">
                        <li v-for="urgent in urgents"
                            ...
                            <div class="absolute top-2 right-2 bg-white p-4 rounded-lg shadow-sm flex flex-col items-start gap-2 z-30"
                                 v-if="showActionsId === urgent.id">
                                <span class="absolute top-2 right-2 hover:cursor-pointer" @click="handleShowActions(null)">
