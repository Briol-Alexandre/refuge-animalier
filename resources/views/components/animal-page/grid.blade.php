<section aria-labelledby="adoptable-animals" class="mt-11 grid-basic">
    <h2 class="title text-center col-span-full" id="adoptable-animals">
        Nos animaux à <strong>l'adoption</strong>
    </h2>
    <div class="container col-start-2 col-end-7 md:col-end-12 flex justify-between gap-x-4 relative">
        <button class="flex items-center bg-white border-2 border-main-yellow rounded-lg self-end h-fit py-1 px-2 btn-open gap-2 hover:cursor-pointer">
            <x-svgs.filters/>
            Filtres
        </button>
        <div class="filters-container relative">
            <form method="dialog">
                <button type="submit" class="close-form flex gap-2 items-center absolute top-4 right-4 md:top-[6.5px] md:left-[10px] hover:cursor-pointer">
                    <svg
            ...
            <form action="" class="filters-content">
                ...
                <x-form.select
                    ...
                    :options="[
                    ['value'=>'', 'name' => 'Tous'],
                    ['value'=>'male', 'name' => 'Mâle'],
                    ['value'=>'female', 'name' => 'Femelle']
                ]"
                />
                <div class="flex flex-col">
                    <label for="search">Rechercher</label>
                    <input type="search" id="search" name="search" placeholder="Rechercher un nom…"
    ...
    <ul class="col-start-2 col-end-7 md:col-end-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        @for ($i = 1; $i <= 20; $i++)
            <li class="col-span-1">
                <x-slider.animal-card
                    :name="'J.P. Rouve'"
                    :breed="'G. Retriever'"
                    :age="'3 mois'"
                    :desc="'Lorem Ipsum posjdqihufgjhbilwqg pqisgdo dfuyh gpiqvsf gh q ghvfuidg piqsufhgliudfghduhgpq qt p'"
